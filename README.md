...
- :electric_plug: Plugins for popular IDEs available ([JetBrains](https://plugins.jetbrains.com/plugin/18687-tfsec-findings-explorer), [VSCode](https://marketplace.visualstudio.com/items?itemName=tfsec.tfsec) and [Vim](https://github.com/khulnasoft/vim-tfsec))
...
You can now install the [official tfsec task](https://marketplace.visualstudio.com/items?itemName=KhulnaSoftOfficial.tfsec-official). Please raise any issues/feature requests on the [task repository](https://github.com/khulnasoft/tfsec-azure-pipelines-task).
...
| Checks                                                                                |
| :------------------------------------------------------------------------------------ |
| [AWS Checks](https://khulnasoft.github.io/tfsec/latest/checks/aws/)                   |
| [Azure Checks](https://khulnasoft.github.io/tfsec/latest/checks/azure/)               |
| [GCP Checks](https://khulnasoft.github.io/tfsec/latest/checks/google/)                |
| [CloudStack Checks](https://khulnasoft.github.io/tfsec/latest/checks/cloudstack/)     |
| [DigitalOcean Checks](https://khulnasoft.github.io/tfsec/latest/checks/digitalocean/) |
| [GitHub Checks](https://khulnasoft.github.io/tfsec/latest/checks/github/)             |
| [Kubernetes Checks](https://khulnasoft.github.io/tfsec/latest/checks/kubernetes/)     |
| [OpenStack Checks](https://khulnasoft.github.io/tfsec/latest/checks/openstack/)       |
| [Oracle Checks](https://khulnasoft.github.io/tfsec/latest/checks/oracle/)             |
...
`tfsec` is an [KhulnaSoft Security](https://khulnasoft.com) open source project.
Learn about our open source work and portfolio [here](https://www.khulnasoft.com/products/open-source-projects/).
Join the community, and talk to us about any matter in [GitHub Discussion](https://github.com/khulnasoft/tfsec/discussions) or [Slack](https://slack.khulnasoft.com).
